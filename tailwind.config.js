module.exports = {
  content: ["./*.html", "./pages/*.{html,js}", "./js/*.js"],
  theme: {
    extend: {
      colors: {
        // Primary Colors - Empowering life-force, heroic action
        primary: {
        ...
        // Secondary Colors - Trustworthy medical authority
        secondary: {
        ...
        // Accent Colors - Positive health outcomes
        accent: {
        ...
        error: "#ef4444", // red-500 - Helpful medical concern
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'form': '0 0 0 3px rgba(220, 38, 38, 0.1)',
      },
      borderRadius: {
        'xl': '0.75rem',
        '2xl': '1rem',
